...
We can see this total cost in the deployment transaction on [Sepolia Etherscan](https://sepolia.etherscan.io/tx/0xc496b9d30df33aa9285ddd384c14ce2a58eef470898b5cda001d0f4a21b017f6), under the `Transaction Fee` section. In this case, `357,498` gas will cost `0.000279288255846978` ETH, which today is equivalent to $7.
...
> 🗒️ NOTE  
> To understand the cost benefits of Layer 2 solutions, visit [L2Fees.info](https://l2fees.info/) and compare the significant cost differences bewteen sending a transaction on Ethereum and ZKsync Era.