...
1. Open the Extensions view:
    * There are two ways to do this:
      ...
      * Use the shortcut Ctrl+Shift+X (Win/Linux) or Cmd+Shift+X (Mac).
...
3. Install the extension:
    * Once you've found the extension you want, click the "Install" button. VS Code will handle the download and installation process.
...
`CTRL(SMD) + '` opens/closes your terminal. It's the equicalent of pressing the `X` button on the top right part of your terminal.
